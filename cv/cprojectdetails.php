...
$sql = "SELECT PROJECTDETAILS FROM PROJECTDETAILS";
$result = $con->query($sql);

if ($result->num_rows > 0) {
  // output data of each row
  echo "<h3>M.Tech. Final year:</h3>";
  if($row = $result->fetch_assoc()) 
  {
    echo "Title : ".$row["PROJECTDETAILS"]."<br/><br/>" ;
  }
  if($row = $result->fetch_assoc())
  {
    echo "Role :".$row["PROJECTDETAILS"]."<br/><br/>" ;
  }
    if($row = $result->fetch_assoc())
  {
    echo "Purpose of the Project : ".$row["PROJECTDETAILS"]."<br/><br/>" ;
    
  }
  if($row = $result->fetch_assoc())
  {
    echo "Software Requirement : ".$row["PROJECTDETAILS"]."<br/><br/>" ;
    
  }
  if($row = $result->fetch_assoc())
  {
    echo "Team members : ".$row["PROJECTDETAILS"]."<br/><br/>" ;
    
  }


echo "<h3>M.Tech. Pre Final year:</h3>";
  if($row = $result->fetch_assoc()) 
  {
    echo "Title : ".$row["PROJECTDETAILS"]."<br/><br/>" ;
  }
