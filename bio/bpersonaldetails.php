...
if ($result->num_rows > 0) {
  ...
  {
    echo "Full Name : ".$row["PERSONALDETAILS"]."<br/><br/>" ;
  }
  if($row = $result->fetch_assoc())
  {
    echo "Date of Birth : ".$row["PERSONALDETAILS"]."<br/><br/>" ;
  }
  if($row = $result->fetch_assoc())
  {
    echo "Gender : ".$row["PERSONALDETAILS"]."<br/><br/>" ;
  }
  if($row = $result->fetch_assoc())
  {
    echo "Religion : ".$row["PERSONALDETAILS"]."<br/><br/>" ;
  }
  if($row = $result->fetch_assoc())
  {
    echo "Race : ".$row["PERSONALDETAILS"]."<br/><br/>" ;
  }
  if($row = $result->fetch_assoc())
  {
    echo "Nationality : ".$row["PERSONALDETAILS"]."<br/><br/>" ;
  }
  if($row = $result->fetch_assoc())
  {
    echo "Marital status : ".$row["PERSONALDETAILS"]."<br/><br/>" ;
  }
  if($row = $result->fetch_assoc())
  {
    echo "Home Address : ".$row["PERSONALDETAILS"]."<br/><br/>" ;
  }



  echo "Languages Known : <br/><br/>";
    if($row = $result->fetch_assoc())
  {
    echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp".$row["PERSONALDETAILS"]."<br/><br/>" ;
  ...
  if($row = $result->fetch_assoc())
  {
    echo "Mobile : ".$row["PERSONALDETAILS"]."<br/><br/>" ;
    
  }
  if($row = $result->fetch_assoc())
  {
    echo "Email : ".$row["PERSONALDETAILS"]."<br/><br/>" ;
    
  }
    if($row = $result->fetch_assoc())
  {
    echo "Membership : ".$row["PERSONALDETAILS"]."<br/><br/>" ;
    
  }
  if($row = $result->fetch_assoc())
  {
    echo "URL : ".$row["PERSONALDETAILS"]."<br/><br/>" ;
